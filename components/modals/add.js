...
const AddModal = ({ toggle, openAddModal, setOpenAddModal, mutate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('/gpass/api/gpass', {
        payload: Data,
      });
      toast.success('Maklumat berjaya ditambah');
      mutate();
    } catch (err) {
      toast.error('Maklumat gagal ditambah');
      console.log(err);
    } finally {
      setAddingData(false);
                ...
                <form onSubmit={handleSubmit}>
                  <div>
                    ...
                    <div className='mt-3 text-center sm:mt-5'>
                      ...
                      >
                        Daftar {toggle === 'kkiakd' ? 'KKIA / KD' : toggle} Baru
                      </Dialog.Title>
                      <div className='mt-2'>
